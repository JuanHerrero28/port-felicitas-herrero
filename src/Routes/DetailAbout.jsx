      ...
      <div className="detail-about-grid">
        ...
        <div className="paragraph-1">
          <p>
            ...
            expandir hacia nuevos conocimientos, especialmente en el diseño web,
            con un enfoque particular en la interfaz de usuario (UI). Nací en la
            ciudad de Nueve de Julio (Provincia de Buenos Aires), mi búsqueda de
            conocimiento y crecimiento me llevó a Buenos Aires a los 17 años
            para perseguir mis sueños y expandir mis habilidades en diseño.
            Durante tres años he estado explorando el mundo del freelance,
            llevando a cabo proyectos independientes que me desafían a crecer y
            evolucionar como profesional.
          </p>
        </div>
        <ul className="numbered-list">
          <li>2022 Diseñadora gráfica part time - <strong style={{ fontWeight: 'bold' }}>Atomic Kitchens</strong></li>
          <li>
            2022 - 2024 Diseñadora gráfica independiente, clientes: <strong style={{ fontWeight: 'bold' }}>Dj y
            productores musicales</strong>
          </li>
        </ul>
        <div className="paragraph-2">
          <p>
            Este portfolio es más que un proyecto práctico; es una manifestación
            de mi dedicación y pasión por el diseño. Me divertí mucho haciéndolo
            y me desafié a mí misma en cada paso del camino, lo que me hizo
            sentir increíblemente bien. Este proyecto fue en conjunto con un
            amigo desarrollador, donde la dinámica de trabajar juntos fue muy
            fluida, he puesto todo mi foco en la creación de experiencias
            visuales cautivadoras y funcionales. Aquí encontrarás un vistazo a
            mi trabajo, desde proyectos de diseño gráfico hasta creaciones web,
            todos ellos creados con amor y dedicación. En mis trabajos
            predominan las figuras geométricas con la intersección entre formas,
            colores y espacios de manera experimental para expresar creatividad
            y originalidad.
          </p>
        </div>
        ...
        <div className="ctn-final">
          <p>¡Gracias por visitar mi espacio creativo! Espero que disfrutes explorando mi trabajo tanto como yo disfruté creándolo.</p>
        </div>
        <BtnTop/>
      </div>
    </>
